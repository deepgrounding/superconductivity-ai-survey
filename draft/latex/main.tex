...
\urlstyle{same}
\hypersetup{
  pdftitle={Mapping Superconductivity Research for AI},
...
\title{Mapping Superconductivity Research for AI}
...
\textbf{These figures score the labels that ship with this paper}, not a
...
\tightlist
\item
  \textbf{Instrument the experiments.} This step is new here, and it is
...
\textbf{AI work is being done inside the field, not imported into it.}
We expected the opposite, and the corpus says otherwise. If AI methods
were arriving with machine-learning groups from outside, AI-tagged
preprints should be filed under different primary categories from the
rest of the corpus. They are not: 68\% of AI-tagged seed papers carry
